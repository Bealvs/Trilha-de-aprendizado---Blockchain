...
// Uma será responsável por criptografar o hash e a outra para deixar a data personalizada (esteticamente bonita)
...
// Vai calcular o hash do bloco com base nos parâmetros
...
blockchain.mineracao([new Transacao("Matheus", 15, "Bitcoins", "Sayke"), new Transacao("Julio Cesar", 20, "Bitcoins", "Matheus"), new Transacao("Guilherme", 12, "Bitcoins", "Samuel")]);
